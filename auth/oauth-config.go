...
///*func (auth *authentication) getTokenFromCache() (*oauth2.Token, error) {
//	// loadTokenFromCache the token from the cache if it doesn't exist.
//	if auth.token == nil {
//		if err := auth.loadTokenFromCache(""); err != nil {
//			// If we cannot loadTokenFromCache the token from disk, authenticateAndSaveToken
//			if err != nil {
//				/*if err = auth.authenticateAndSaveToken(); err != nil {
//					return nil, err
//				}*/
//				//return nil, err
//			}
...
//func (auth *authentication) authenticateAndSaveToken() error {
...
//func (auth *authentication) loadTokenFromCache() (*oauth2.Token, error) {
//	var err error
//
...
//func (auth *authentication) saveTokenInCache(token *oauth2.Token) error {
//	//var err error
//
//	// Get the default cache path or saveTokenInCache the specified path
///*	if path == "" {
//		path, err = auth.cachePath()
//		if err != nil {
//			return err
