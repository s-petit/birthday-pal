...
type App interface {
	Exec(contactsProvider request.ContactsProvider, smtp email.Sender, reminder remind.Criteria, recipients []string) error
}
...
func (bp BirthdayPal) Exec(contactsProvider request.ContactsProvider, smtp email.Sender, remindParams remind.Criteria, recipients []string) error {
