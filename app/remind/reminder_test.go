...
var dataProvider = []dataprovider{
	{Criteria{Today: aug19, InNbDays: 0, Inclusive: false}, []contact.Contact{}},
	{Criteria{Today: aug19, InNbDays: 1, Inclusive: false}, []contact.Contact{john}},
	{Criteria{Today: aug19, InNbDays: 2, Inclusive: false}, []contact.Contact{sara}},
	{Criteria{Today: aug19, InNbDays: 3, Inclusive: false}, []contact.Contact{}},
	{Criteria{Today: aug19, InNbDays: 0, Inclusive: true}, []contact.Contact{}},
	{Criteria{Today: aug19, InNbDays: 1, Inclusive: true}, []contact.Contact{john}},
	{Criteria{Today: aug19, InNbDays: 2, Inclusive: true}, []contact.Contact{john, sara}},
	{Criteria{Today: aug19, InNbDays: 3, Inclusive: true}, []contact.Contact{john, sara}},
	{Criteria{Today: aug20, InNbDays: 0, Inclusive: false}, []contact.Contact{john}},
}

var dataProviderOnSeveralMonths = []dataprovider{
	{Criteria{Today: may30, InNbDays: 0, Inclusive: false}, []contact.Contact{}},
	{Criteria{Today: may30, InNbDays: 1, Inclusive: false}, []contact.Contact{rob}},
	{Criteria{Today: may30, InNbDays: 2, Inclusive: false}, []contact.Contact{jane}},
	{Criteria{Today: may30, InNbDays: 3, Inclusive: false}, []contact.Contact{}},
	{Criteria{Today: may30, InNbDays: 0, Inclusive: true}, []contact.Contact{}},
	{Criteria{Today: may30, InNbDays: 1, Inclusive: true}, []contact.Contact{rob}},
	{Criteria{Today: may30, InNbDays: 2, Inclusive: true}, []contact.Contact{rob, jane}},
	{Criteria{Today: may30, InNbDays: 3, Inclusive: true}, []contact.Contact{rob, jane}},
	{Criteria{Today: may31, InNbDays: 0, Inclusive: false}, []contact.Contact{rob}},
}

var dataProviderOnSeveralYears = []dataprovider{
	{Criteria{Today: dec30, InNbDays: 0, Inclusive: false}, []contact.Contact{}},
	{Criteria{Today: dec30, InNbDays: 1, Inclusive: false}, []contact.Contact{jill}},
	{Criteria{Today: dec30, InNbDays: 2, Inclusive: false}, []contact.Contact{nick}},
	{Criteria{Today: dec30, InNbDays: 3, Inclusive: false}, []contact.Contact{}},
	{Criteria{Today: dec30, InNbDays: 0, Inclusive: true}, []contact.Contact{}},
	{Criteria{Today: dec30, InNbDays: 1, Inclusive: true}, []contact.Contact{jill}},
	{Criteria{Today: dec30, InNbDays: 2, Inclusive: true}, []contact.Contact{jill, nick}},
	{Criteria{Today: dec30, InNbDays: 3, Inclusive: true}, []contact.Contact{jill, nick}},
	{Criteria{Today: dec31, InNbDays: 0, Inclusive: false}, []contact.Contact{jill}},
}
...
func Test_should_remind_on_period_including_different_months(t *testing.T) {
	...
	var params = Criteria{Today: aug30, InNbDays: 3, Inclusive: true}
...
func Test_should_remind_on_period_including_different_years(t *testing.T) {
	...
	var params = Criteria{Today: dec30, InNbDays: 3, Inclusive: true}
...
func Test_should_remind_once_with_different_timezones(t *testing.T) {
	...
	remind20augLA := Reminder{
		contacts,
		Criteria{Today: aug20LA, InNbDays: 0, Inclusive: false},
	}.ContactsToRemind()
	...
	remind20augSydney := Reminder{
		contacts,
		Criteria{Today: aug20Sydney, InNbDays: 0, Inclusive: false},
	}.ContactsToRemind()
	...
	remind20augParis := Reminder{
		contacts,
		Criteria{Today: aug20Paris, InNbDays: 0, Inclusive: false},
	}.ContactsToRemind()
